...
// Componente do botão flutuante do WhatsApp usando Portal
const WhatsAppFloatingButton = () => {
  ...
  useEffect(() => {
    ...
    // Adiciona o CSS da animação no head
    const style = document.createElement('style');
    style.id = 'whatsapp-pulse-animation';
    style.textContent = `
    ...
    `;
    if (!document.getElementById('whatsapp-pulse-animation')) {
      document.head.appendChild(style);
    }

    return () => {
      const existingStyle = document.getElementById('whatsapp-pulse-animation');
      if (existingStyle) {
...
export default function CustomPapersPage() {
  ...
  return (
    ...
    {/* Botão Flutuante do WhatsApp - Renderizado via Portal no body */}

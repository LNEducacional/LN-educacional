...
class NotificationService {
    ...
    async notifyMessageReply(message, replyContent) {
        try {
    ...
    async notifyLegalDocumentUpdate(document) {
        try {
    ...
    async notifyApplicationReceived(applicationId) {
        try {
    ...
    async notifyStageChange(applicationId, newStage) {
        try {
            const { prisma } = await Promise.resolve().then(() => __importStar(require('../prisma')));
            const application = await prisma.collaboratorApplication.findUnique({
                where: { id: applicationId },
    ...
    async notifyInterview(interviewId) {
        try {
            const { prisma } = await Promise.resolve().then(() => __importStar(require('../prisma')));
    ...
    async notifyEvaluation(evaluationId) {
        try {
            const { prisma } = await Promise.resolve().then(() => __importStar(require('../prisma')));
    ...
    generateApplicationReceivedTemplate(application) {
        return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    generateNewApplicationAdminTemplate(admin, application) {
        return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    generateStageUpdateTemplate(application, newStage) {
        const stageLabels = {
    ...
    generateInterviewCandidateTemplate(interview) {
        return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    generateInterviewInterviewerTemplate(interview) {
        return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    generateReplyEmailTemplate(originalMessage, replyContent) {
        return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background-color: #007bff; padding: 20px; text-align: center;">
          <h1 style="color: white; margin: 0;">LN Educacional</h1>
...
exports.notificationService = new NotificationService(notificationConfig);

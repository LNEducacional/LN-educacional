...
export declare function uploadFile(file: any, folder: 'thumbnails' | 'videos' | 'materials' | 'blog-images' | 'collaborator-docs' | 'avatars' | 'lesson-attachments'): Promise<UploadResult>;
